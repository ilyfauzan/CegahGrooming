...
export default function ResultSidebar({ items, onNewAnalysis }: ResultSidebarProps) {
  // Hitung statistik
    ...
    <div className="sticky top-10 space-y-6">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 bg-slate-800/80 hover:bg-red-500/10 border border-slate-700 hover:border-red-500/50 rounded-2xl text-slate-500 hover:text-red-400 text-xs font-black transition-all active:scale-[0.98]"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>

        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-[10px] font-bold transition-all ${activeTab === "single" ? "bg-blue-600 text-white shadow-lg shadow-blue-900/40" : "bg-slate-800 text-slate-400"}`}
            >
              MODE 1: SINGLE
            </button>
            <button
              onClick={() => setActiveTab("window")}
              className={`px-4 py-1.5 rounded-lg text-[10px] font-bold transition-all ${activeTab === "window" ? "bg-blue-600 text-white shadow-lg shadow-blue-900/40" : "bg-slate-800 text-slate-400"}`}
            >
              MODE 2: WINDOW
            </button>
          </div>
